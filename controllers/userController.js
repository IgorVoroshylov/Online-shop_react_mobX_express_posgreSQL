...
// когда дело доходит до авторизации, устанавливаем: npm i jsonwebtoken(генерация токена) bcrypt(чтоб хэшировать пароли и не хранить их в базе данных в открытом виде)
